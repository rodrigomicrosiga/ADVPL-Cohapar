...
/*/
//--------------------------------------------------------------------
User Function UPDSEICE( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSEICE" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSEICE" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'TCEPR - PESSOASEICED'													, ; //X2_NOME
	'TCEPR - PESSOASEICED'													, ; //X2_NOMESPA
	'TCEPR - PESSOASEICED'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'TCEPR - QUADRO DELIBERATIVO'											, ; //X2_NOME
	'TCEPR - QUADRO DELIBERATIVO'											, ; //X2_NOMESPA
	'TCEPR - QUADRO DELIBERATIVO'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'TCEPR - COMP CAPITAL SOCIAL'											, ; //X2_NOME
	'TCEPR - COMP CAPITAL SOCIAL'											, ; //X2_NOMESPA
	'TCEPR - COMP CAPITAL SOCIAL'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'GETSXENUM("SZI","ZI_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr Documento'														, .T. }, ; //X3_TITULO
	{ 'Nr Documento'														, .T. }, ; //X3_TITSPA
	{ 'Nr Documento'														, .T. }, ; //X3_TITENG
	{ 'Numero Documento'													, .T. }, ; //X3_DESCRIC
	{ 'Numero Documento'													, .T. }, ; //X3_DESCSPA
	{ 'Numero Documento'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 'Tipo de Documento'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo de Documento'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo de Documento'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=CNPJ;2=CPF;3=RG;4=OAB;5=CREA;6=CAU;7=CRC;97=SEMDCTO;98=EST'		, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 'Complemento do Endereco'												, .T. }, ; //X3_DESCRIC
	{ 'Complemento do Endereco'												, .T. }, ; //X3_DESCSPA
	{ 'Complemento do Endereco'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCRIC
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCSPA
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'GETSXENUM("SZJ","ZJ_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_CDNATUR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nat Qd Delib'														, .T. }, ; //X3_TITULO
	{ 'Nat Qd Delib'														, .T. }, ; //X3_TITSPA
	{ 'Nat Qd Delib'														, .T. }, ; //X3_TITENG
	{ 'Natureza Quadro Deliberat'											, .T. }, ; //X3_DESCRIC
	{ 'Natureza Quadro Deliberat'											, .T. }, ; //X3_DESCSPA
	{ 'Natureza Quadro Deliberat'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Conselho ADM;2=Conselho Fiscal;3=Direcao'							, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_CDTPFUN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Tip Func'														, .T. }, ; //X3_TITULO
	{ 'Cod Tip Func'														, .T. }, ; //X3_TITSPA
	{ 'Cod Tip Func'														, .T. }, ; //X3_TITENG
	{ 'Codigo Tipo Funcao'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Tipo Funcao'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Tipo Funcao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Presidente;2=Vice Presidente;3=Diretor Presidente;4=Diretor Financeiro;5=Outros Diretores;6=Membro;7=Suplente', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 'Data Inicio'															, .T. }, ; //X3_DESCSPA
	{ 'Data Inicio'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Data Fim'															, .T. }, ; //X3_TITSPA
	{ 'Data Fim'															, .T. }, ; //X3_TITENG
	{ 'Data Fim'															, .T. }, ; //X3_DESCRIC
	{ 'Data Fim'															, .T. }, ; //X3_DESCSPA
	{ 'Data Fim'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_DTPRFIM'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt Prev Fim'															, .T. }, ; //X3_TITULO
	{ 'Dt Prev Fim'															, .T. }, ; //X3_TITSPA
	{ 'Dt Prev Fim'															, .T. }, ; //X3_TITENG
	{ 'Data Previsao Fim'													, .T. }, ; //X3_DESCRIC
	{ 'Data Previsao Fim'													, .T. }, ; //X3_DESCSPA
	{ 'Data Previsao Fim'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_CDMOTBX'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd Mot Baixa'														, .T. }, ; //X3_TITULO
	{ 'Cd Mot Baixa'														, .T. }, ; //X3_TITSPA
	{ 'Cd Mot Baixa'														, .T. }, ; //X3_TITENG
	{ 'Codigo Motivo Baixa'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Motivo Baixa'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Motivo Baixa'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Fim do Mandato;2=Renuncia;3=Destituicao;4=Falecimento;99=Outros Motivos', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_DESCRBX'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descr Baixa'															, .T. }, ; //X3_TITULO
	{ 'Descr Baixa'															, .T. }, ; //X3_TITSPA
	{ 'Descr Baixa'															, .T. }, ; //X3_TITENG
	{ 'Descricao Baixa'														, .T. }, ; //X3_DESCRIC
	{ 'Descricao Baixa'														, .T. }, ; //X3_DESCSPA
	{ 'Descricao Baixa'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_DTALTER'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt Altera'															, .T. }, ; //X3_TITULO
	{ 'Dt Altera'															, .T. }, ; //X3_TITSPA
	{ 'Dt Altera'															, .T. }, ; //X3_TITENG
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCRIC
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCSPA
	{ 'Data de Alteracao'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SZK'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZK_TPACAO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Acao'															, .T. }, ; //X3_TITULO
	{ 'Tipo Acao'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Acao'															, .T. }, ; //X3_TITENG
	{ 'Tipo Acao'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Acao'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Acao'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Ordinaria;2=Preferencial'											, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SZK'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZK_NRACOES'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr Acoes'															, .T. }, ; //X3_TITULO
	{ 'Nr Acoes'															, .T. }, ; //X3_TITSPA
	{ 'Nr Acoes'															, .T. }, ; //X3_TITENG
	{ 'Numero Acoes'														, .T. }, ; //X3_DESCRIC
	{ 'Numero Acoes'														, .T. }, ; //X3_DESCSPA
	{ 'Numero Acoes'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 'Data Termino'														, .T. }, ; //X3_DESCRIC
	{ 'Data Termino'														, .T. }, ; //X3_DESCSPA
	{ 'Data Termino'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZI'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZI_FILIAL+ZI_TIPODOC+ZI_NRDOC'											, ; //CHAVE
	'Tipo Documen+Nr Documento'												, ; //DESCRICAO
	'Tipo Documen+Nr Documento'												, ; //DESCSPA
	'Tipo Documen+Nr Documento'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZJ'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZJ_FILIAL+ZJ_NRDOC'													, ; //CHAVE
	'Nr Documento'															, ; //DESCRICAO
	'Nr Documento'															, ; //DESCSPA
	'Nr Documento'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZK'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZK_FILIAL+ZK_TIPODOC+ZK_NRDOC'											, ; //CHAVE
	'Tp Documento+Nr Documento'												, ; //DESCRICAO
	'Tp Documento+Nr Documento'												, ; //DESCSPA
	'Tp Documento+Nr Documento'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'TCEPR - PessoaSEICED'													, ; //XB_DESCRI
	'TCEPR - PessoaSEICED'													, ; //XB_DESCSPA
	'TCEPR - PessoaSEICED'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZI'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Tipo documen+nr docu'													, ; //XB_DESCRI
	'Tipo documen+nr docu'													, ; //XB_DESCSPA
	'Tipo documen+nr docu'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'Tipo Documen'															, ; //XB_DESCRI
	'Tipo Documen'															, ; //XB_DESCSPA
	'Tipo Documen'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZI_TIPODOC'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'04'																	, ; //XB_COLUNA
	'Nr Documento'															, ; //XB_DESCRI
	'Nr Documento'															, ; //XB_DESCSPA
	'Nr Documento'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZI_NRDOC'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'TCE - PessoaSEICED'													, ; //XB_DESCRI
	'TCE - PessoaSEICED'													, ; //XB_DESCSPA
	'TCE - PessoaSEICED'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZI'																	} ) //XB_CONTEM
