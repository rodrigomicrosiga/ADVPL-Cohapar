...
// Tentativas
//RC_PD = '103' 
//CASE  WHEN SUM(RC_VALOR103) > 0 THEN SUM(RC_VALOR103) / CASE WHEN (SELECT SUM(H.RC_HORAS) FROM %table:SRC% H WHERE H.RC_PD = '102' AND H.RC_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RC_HORAS) FROM %table:SRC% H WHERE H.RC_PD = '102' AND H.RC_MAT = RA_MAT ) ELSE CASE WHEN (SELECT SUM(I.RC_HORAS) FROM %table:SRC% I WHERE I.RC_PD = '101' AND I.RC_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(I.RC_HORAS) FROM %table:SRC% I WHERE I.RC_PD = '101' AND I.RC_MAT = RA_MAT ) ELSE 30 END END * 30 ELSE 0 END as AdTempoServico,
//CASE  WHEN RC_PD = '103' THEN SUM(RC_VALOR103) / %Exp:nDias% * 30 ELSE 0 END as AdTempoServico,
//SUM(CASE WHEN RC_PD = '103' THEN RC_VALOR103 / CASE WHEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '102' AND G.RC_MAT = RC_MAT ) > 0 THEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '102' AND G.RC_MAT = RC_MAT ) ELSE CASE WHEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '101' AND G.RC_MAT = RC_MAT ) > 0 THEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '101' AND G.RC_MAT = RC_MAT ) ELSE 30 END END * 30 ELSE 0 END) as AdTempoServico,
//CASE WHEN SUM(RC_VALOR102) > 0 THEN SUM(RC_VALOR102) ELSE RA_SALARIO END + SUM(CASE  WHEN RC_PD = '103' THEN RC_VALOR103 ELSE 0 END) + CASE WHEN ra_fgratif > 0 THEN ra_fgratif ELSE SUM(CASE  WHEN RC_PD = '300' THEN RC_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '104' THEN RC_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '117' THEN RC_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RC_PD = '308' THEN RC_VALOR308 ELSE 0 END) END as Total,


CASE WHEN SUM(RC_VALOR102) > 0 THEN SUM(RC_VALOR102) / CASE WHEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '102' AND G.RC_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RC_HORAS) FROM %table:SRC% H WHERE H.RC_PD = '102' AND H.RC_MAT = RA_MAT ) ELSE 30 END * 30 ELSE RA_SALARIO END as RA_SALARIO,
CASE WHEN SUM(RC_VALOR103) > 0 THEN SUM(RC_VALOR103) / CASE WHEN SUM(RC_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(I.RC_HORAS) FROM %table:SRC% I WHERE I.RC_PD = '102' AND I.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(J.RC_HORAS) FROM %table:SRC% J WHERE J.RC_PD = '102' AND J.RC_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RC_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(K.RC_HORAS) FROM %table:SRC% K WHERE K.RC_PD = '101' AND K.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(L.RC_HORAS) FROM %table:SRC% L WHERE L.RC_PD = '101' AND L.RC_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END * 30 ELSE 0 END as AdTempoServico,
CASE WHEN ra_fgratif > 0 THEN ra_fgratif ELSE (SUM(CASE  WHEN RC_PD = '300' THEN RC_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '104' THEN RC_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '117' THEN RC_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RC_PD = '308' THEN RC_VALOR308 ELSE 0 END)) / CASE WHEN SUM(RC_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RC_HORAS) FROM %table:SRC% N WHERE N.RC_PD = '102' AND N.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RC_HORAS) FROM %table:SRC% O WHERE O.RC_PD = '102' AND O.RC_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RC_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RC_HORAS) FROM %table:SRC% P WHERE P.RC_PD = '101' AND P.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RC_HORAS) FROM %table:SRC% Q WHERE Q.RC_PD = '101' AND Q.RC_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 END as FuncaoGratificada, //,SUM(CASE  WHEN RC_PD = '300' THEN RC_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '104' THEN RC_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '117' THEN RC_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RC_PD = '308' THEN RC_VALOR308 ELSE 0 END) as FuncaoGratificada,
CASE WHEN SUM(RC_VALOR102) > 0 THEN SUM(RC_VALOR102) / CASE WHEN (SELECT SUM(G.RC_HORAS) FROM %table:SRC% G WHERE G.RC_PD = '102' AND G.RC_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RC_HORAS) FROM %table:SRC% H WHERE H.RC_PD = '102' AND H.RC_MAT = RA_MAT ) ELSE 30 END * 30 ELSE RA_SALARIO END + CASE WHEN SUM(RC_VALOR103) > 0 THEN SUM(RC_VALOR103) / CASE WHEN SUM(RC_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(I.RC_HORAS) FROM %table:SRC% I WHERE I.RC_PD = '102' AND I.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(J.RC_HORAS) FROM %table:SRC% J WHERE J.RC_PD = '102' AND J.RC_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RC_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(K.RC_HORAS) FROM %table:SRC% K WHERE K.RC_PD = '101' AND K.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(L.RC_HORAS) FROM %table:SRC% L WHERE L.RC_PD = '101' AND L.RC_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END * 30 ELSE 0 END + CASE WHEN ra_fgratif > 0 THEN ra_fgratif ELSE (SUM(CASE  WHEN RC_PD = '300' THEN RC_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '104' THEN RC_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RC_PD = '117' THEN RC_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RC_PD = '308' THEN RC_VALOR308 ELSE 0 END)) / CASE WHEN SUM(RC_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RC_HORAS) FROM %table:SRC% N WHERE N.RC_PD = '102' AND N.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RC_HORAS) FROM %table:SRC% O WHERE O.RC_PD = '102' AND O.RC_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RC_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RC_HORAS) FROM %table:SRC% P WHERE P.RC_PD = '101' AND P.RC_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RC_HORAS) FROM %table:SRC% Q WHERE Q.RC_PD = '101' AND Q.RC_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 END as Total, 
chefe
from
(
select   
...
ra_fgratif,
ra_mat,
CASE  WHEN RC_PD = '101' THEN RC_VALOR ELSE 0 END as RC_VALOR101,
...
//CASE WHEN ra_fgratif > 0 THEN ra_fgratif ELSE (SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END)) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RD_HORAS) FROM %table:SRD% N WHERE N.RD_PD = '102' AND N.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RD_HORAS) FROM %table:SRD% O WHERE O.RD_PD = '102' AND O.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RD_HORAS) FROM %table:SRD% P WHERE P.RD_PD = '101' AND P.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RD_HORAS) FROM %table:SRD% Q WHERE Q.RD_PD = '101' AND Q.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 END as FuncaoGratificada, //,SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END) as FuncaoGratificada,
//CASE WHEN SUM(RD_VALOR102) > 0 THEN SUM(RD_VALOR102) / CASE WHEN (SELECT SUM(G.RD_HORAS) FROM %table:SRD% G WHERE G.RD_PD = '102' AND G.RD_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RD_HORAS) FROM %table:SRD% H WHERE H.RD_PD = '102' AND H.RD_MAT = RA_MAT ) ELSE 30 END * 30 ELSE RA_SALARIO END + CASE WHEN SUM(RD_VALOR103) > 0 THEN SUM(RD_VALOR103) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(I.RD_HORAS) FROM %table:SRD% I WHERE I.RD_PD = '102' AND I.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(J.RD_HORAS) FROM %table:SRD% J WHERE J.RD_PD = '102' AND J.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(K.RD_HORAS) FROM %table:SRD% K WHERE K.RD_PD = '101' AND K.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(L.RD_HORAS) FROM %table:SRD% L WHERE L.RD_PD = '101' AND L.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END * 30 ELSE 0 END + CASE WHEN ra_fgratif > 0 THEN ra_fgratif ELSE (SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END)) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RD_HORAS) FROM %table:SRD% N WHERE N.RD_PD = '102' AND N.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RD_HORAS) FROM %table:SRD% O WHERE O.RD_PD = '102' AND O.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RD_HORAS) FROM %table:SRD% P WHERE P.RD_PD = '101' AND P.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RD_HORAS) FROM %table:SRD% Q WHERE Q.RD_PD = '101' AND Q.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 END as Total, 

*/
// NOVO TRAZENDO COMPLETO
CASE WHEN SUM(RD_VALOR102) > 0 THEN SUM(RD_VALOR102) / CASE WHEN (SELECT SUM(G.RD_HORAS) FROM %table:SRD% G WHERE G.RD_PD = '102' AND G.RD_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RD_HORAS) FROM %table:SRD% H WHERE H.RD_PD = '102' AND H.RD_MAT = RA_MAT ) ELSE 30 END * 30 ELSE RA_SALARIO END as RA_SALARIO,
CASE WHEN SUM(RD_VALOR103) > 0 THEN SUM(RD_VALOR103) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(I.RD_HORAS) FROM %table:SRD% I WHERE I.RD_PD = '102' AND I.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(J.RD_HORAS) FROM %table:SRD% J WHERE J.RD_PD = '102' AND J.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(K.RD_HORAS) FROM %table:SRD% K WHERE K.RD_PD = '101' AND K.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(L.RD_HORAS) FROM %table:SRD% L WHERE L.RD_PD = '101' AND L.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END * 30 ELSE 0 END as AdTempoServico,
SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RD_HORAS) FROM %table:SRD% N WHERE N.RD_PD = '102' AND N.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RD_HORAS) FROM %table:SRD% O WHERE O.RD_PD = '102' AND O.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RD_HORAS) FROM %table:SRD% P WHERE P.RD_PD = '101' AND P.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RD_HORAS) FROM %table:SRD% Q WHERE Q.RD_PD = '101' AND Q.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 as FuncaoGratificada, //,SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END) as FuncaoGratificada,
CASE WHEN SUM(RD_VALOR102) > 0 THEN SUM(RD_VALOR102) / CASE WHEN (SELECT SUM(G.RD_HORAS) FROM %table:SRD% G WHERE G.RD_PD = '102' AND G.RD_MAT = RA_MAT ) <> 0 THEN  (SELECT SUM(H.RD_HORAS) FROM %table:SRD% H WHERE H.RD_PD = '102' AND H.RD_MAT = RA_MAT ) ELSE 30 END * 30 ELSE RA_SALARIO END + CASE WHEN SUM(RD_VALOR103) > 0 THEN SUM(RD_VALOR103) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(I.RD_HORAS) FROM %table:SRD% I WHERE I.RD_PD = '102' AND I.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(J.RD_HORAS) FROM %table:SRD% J WHERE J.RD_PD = '102' AND J.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(K.RD_HORAS) FROM %table:SRD% K WHERE K.RD_PD = '101' AND K.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(L.RD_HORAS) FROM %table:SRD% L WHERE L.RD_PD = '101' AND L.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END * 30 ELSE 0 END + SUM(CASE  WHEN RD_PD = '300' THEN RD_VALOR300 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '104' THEN RD_VALOR104 ELSE 0 END) + SUM(CASE  WHEN RD_PD = '117' THEN RD_VALOR117 ELSE 0 END)  + SUM(CASE  WHEN RD_PD = '308' THEN RD_VALOR308 ELSE 0 END) / CASE WHEN SUM(RD_VALOR102) > 0 THEN CASE WHEN (SELECT SUM(N.RD_HORAS) FROM %table:SRD% N WHERE N.RD_PD = '102' AND N.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(O.RD_HORAS) FROM %table:SRD% O WHERE O.RD_PD = '102' AND O.RD_MAT = RA_MAT ) ELSE 30 END ELSE CASE WHEN SUM(RD_VALOR101) > 0 THEN CASE WHEN (SELECT SUM(P.RD_HORAS) FROM %table:SRD% P WHERE P.RD_PD = '101' AND P.RD_MAT = RA_MAT ) <> 0 THEN (SELECT SUM(Q.RD_HORAS) FROM %table:SRD% Q WHERE Q.RD_PD = '101' AND Q.RD_MAT = RA_MAT ) ELSE 30 END ELSE 30 END END *30 as Total, 
chefe
...
ra_mat,
RA_CARGOC1,
CASE  WHEN RD_PD = '101' THEN RD_VALOR ELSE 0 END as RD_VALOR101,
